var adBlock = function(view){
  ...
  [
    ...
    "*://*/*/adflashes/**",
    "*://*/*/adfliction-*",
    "*://*/*/adflow.$domain=~adflow.io|~adflow.pl*",
    "*://*/*/adfly/**",
    "*://*/*/adfolder/**",
    "*://*/*/adfootcenter.*",
    "*://*/*/adfooter.*",
    ...
    "*://*/*/adlens-*",
    "*://*/*/adlesse.*",
    "*://*/*/adlib.$domain=~adlib.info|~adlib.mu*",
    "*://*/*/adlift4.*",
    "*://*/*/adlift4_*",
    ...
    "*://*/*/advertical.*",
    "*://*/*/advertise-*",
    "*://*/*/advertise.$domain=~advertise.apartments.com|~advertise.bingads.microsoft.com|~advertise.directoryofillustration.com|~advertise.isleofskye.com|~advertise.market|~advertise.medillsb.com|~advertise.movem.co.uk|~advertise.sobihamilton.ca|~advertise.sphamovingads.com|~engineering.com*",
    ...
    "*://*/*/advertises/**",
    "*://*/*/advertisewithus_*",
    "*://*/*/advertising-$domain=~abramarketing.com|~advertising-direct.com|~advertising-factory.de|~outbrain.com|~yellowimages.com*",
    "*://*/*/advertising.$domain=~advertising.berlin-airport.de|~advertising.bulurum.com|~advertising.byhoxby.com|~advertising.dailymotion.com|~advertising.expedia.com|~advertising.lavenir.net|~advertising.mobile.de|~advertising.sevenwestmedia.com.au|~advertising.shpock.com|~advertising.theguardian.com*",
    "*://*/*/advertising/*$~xmlhttprequest,domain=~commercialplanet.eu|~kloterfarms.com|~temple.edu|~themarker.com*",
    "*://*/*/advertising02.*",
    "*://*/*/advertising2.*",
    "*://*/*/advertising300x250.*",
    "*://*/*/advertising?*",
   ...
   */
   if (view)
   {
    view.request.onBeforeRequest.addListener(function(details){
        console.log('AdBlocker Action! Blocked!', details.url);
        return {cancel: true};
      }, { urls: window.AdBlockList}, ['blocking']);
   }
   else
   {
